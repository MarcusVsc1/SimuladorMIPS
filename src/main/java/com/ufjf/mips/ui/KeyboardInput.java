...
import com.ufjf.mips.utils.InputValidator;
 ...
 * @author Nova
 */
public class KeyboardInput extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Input de caracteres para Simulador MIPS");
        setResizable(false);

        label1.setText("Entre com o input desejado a seguir:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KeyboardInput.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
